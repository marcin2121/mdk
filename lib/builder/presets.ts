    ...
    children: [
       // NAVBAR
       {
         ...
         children: [
            ...
            { id: "nav_btn", type: "Button", props: { label: "Zaloguj Się", className: "px-5 py-1.5 bg-white text-black font-bold rounded-full text-xs hover:bg-[#f97316] hover:text-white transition-all shadow-lg shadow-white/5" }, children: [] }
         ]
       },
       // HERO SEKCJA
       {
         ...
         children: [
            ...
            { id: "hero_head", type: "Heading", props: { text: "Buduj Aplikacje Bez Limitów.", className: "text-6xl sm:text-7xl font-black text-white tracking-tighter mb-6 max-w-4xl bg-clip-text bg-gradient-to-b from-white via-white to-zinc-600 !text-transparent" }, children: [] },
            { id: "hero_txt", type: "Text", props: { text: "Ewolucja standardowych boilerplate'ów. Specjalistyczny development kit z wbudowaną kaskadą modularnego renderowania na brzegach sieci.", className: "text-zinc-500 text-base max-w-2xl mb-10 leading-relaxed font-medium" }, children: [] },
            {
                id: "hero_actions", type: "Column", props: { className: "flex items-center gap-4" }, children: [
                    { id: "hero_btn", type: "Button", props: { label: "Zacznij Już Teraz", className: "px-6 py-3 bg-[#f97316] text-black font-extrabold rounded-full text-xs shadow-xl shadow-[#f97316]/20 hover:scale-105 hover:bg-white transition-all" }, children: [] },
               ...
               children: [
                  {
                     id: "f_1", type: "Card", props: { className: "p-8 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl flex flex-col gap-4 group hover:border-[#f97316]/40 transition-all hover:translate-y-[-4px] shadow-2xl" }, children: [
                        ...
                        { id: "f_1_txt", type: "Text", props: { text: "Aplikacje renderowane brzegowo pod najniższe opóźnienia node'ów Vercel we wszystkich regionach.", className: "text-sm text-zinc-500 leading-relaxed" }, children: [] }
                     ]
                   },
                  {
                     id: "f_2", type: "Card", props: { className: "p-8 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl flex flex-col gap-4 group hover:border-[#f97316]/40 transition-all hover:translate-y-[-4px] shadow-2xl" }, children: [
                        ...
                        { id: "f_2_head", type: "Heading", props: { text: "Bezpieczeństwo Poziomu Enterprise", className: "text-lg font-black text-white group-hover:text-[#f97316] transition-colors" }, children: [] },
                        { id: "f_2_txt", type: "Text", props: { text: "Natywna integracja row-level security (RLS) oparta o Supabase SSR dająca 100% pewności izolacji tenantów.", className: "text-sm text-zinc-500 leading-relaxed" }, children: [] }
                     ]
                  },
                  {
                     id: "f_3", type: "Card", props: { className: "p-8 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl flex flex-col gap-4 group hover:border-[#f97316]/40 transition-all hover:translate-y-[-4px] shadow-2xl" }, children: [
                        ...
                        { id: "f_3_head", type: "Heading", props: { text: "Wydajność 100/100 Core Vitals", className: "text-lg font-black text-white group-hover:text-[#f97316] transition-colors" }, children: [] },
                        { id: "f_3_txt", type: "Text", props: { text: "Zielone wskaźniki Google PageSpeed dzięki optymalizacji drzewa DOM i dynamicznym bundle splittery.", className: "text-sm text-zinc-500 leading-relaxed" }, children: [] }
                     ]
                  }
               ]
            }
    ...
    children: [
       {
         ...
         children: [
            ...
            { id: "p_head", type: "Heading", props: { text: "Kreujemy Cyfrowe Moduły Nowej Generacji.", className: "text-5xl sm:text-7xl font-black text-white uppercase tracking-tighter max-w-4xl mb-6 leading-[0.9]" }, children: [] },
            { id: "p_txt", type: "Text", props: { text: "Pomagam markom i startupom przełamywać standardowe ramy rynkowe w oparciu o płynne i animowane visuale krawędziowe bez spowalniania TTFB.", className: "text-base text-zinc-400 max-w-xl mb-8" }, children: [] },
